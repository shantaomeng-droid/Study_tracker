...
export function Calendar() {
  ...
  return (
    <>
      <div className="flex items-center justify-between flex-wrap gap-4 border-t border-border pt-6 mb-3">
      ...
      <p className="text-sm text-muted-foreground mb-8">
        Assignments appear on their due dates. Click a date number to open that day's to-do list.
      </p>
                ...
                <>
                  ...
                  <div className="flex flex-col gap-1">
                    {items.map((a) => (
                      ...
                      >
                        <span className={`shrink-0 w-1.5 h-1.5 rounded-full ${PRIORITY_META[a.priority].dot}`} />
      ...
      <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mt-6">
        ...
        {(["high", "medium", "low"] as const).map((p) => (
          <div key={p} className="flex items-center gap-2">
            ...
            <span className="text-[11px] tracking-[0.1em] uppercase text-muted-foreground" style={mono}>
